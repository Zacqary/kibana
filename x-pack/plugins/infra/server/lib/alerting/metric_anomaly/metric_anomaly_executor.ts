...
import { AlertStates, MetricAnomalyExpressionParams } from './types';
...
interface MetricAnomalyParams {
  condition: MetricAnomalyExpressionParams;
  filterQuery: string | undefined;
  sourceId?: string;
  alertOnNoData?: boolean;
}

export const createMetricAnomalyExecutor = (libs: InfraBackendLibs) => async ({
  services,
  params,
}: AlertExecutorOptions) => {
  const { condition, filterQuery, sourceId, alertOnNoData } = params as MetricAnomalyParams;
